...
var CodePush = (function () {
    ...
    CodePush.prototype.checkForUpdate = function (querySuccess, queryError, deploymentKey, clientUniqueId) {
        try {
            ...
            }, deploymentKey, /*contentType*/null, clientUniqueId);
        }
        catch (e) {
    ...
    CodePush.prototype.syncInternal = function (syncCallback, syncOptions, downloadProgress) {
        ...
        window.codePush.checkForUpdate(onUpdate, onError, syncOptions.deploymentKey, syncOptions.clientUniqueId);
    };
